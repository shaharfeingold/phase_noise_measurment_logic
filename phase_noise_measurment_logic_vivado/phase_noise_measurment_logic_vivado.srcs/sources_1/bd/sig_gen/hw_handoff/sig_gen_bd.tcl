...
################################################################
# This is a generated script based on design: sig_gen
#
...
proc create_hier_cell_PS { parentCell nameHier } {
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PS_M00_AXI [get_bd_intf_pins PS/M00_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins dds_compiler_0/s_axis_phase_tdata]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PS/FCLK_CLK0] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axis_red_pitaya_dac_0/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins dds_compiler_0/aclk]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins PS/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins dds_compiler_0/aresetn]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
