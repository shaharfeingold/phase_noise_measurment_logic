...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_4_util_ds_buf_2_0 -prefix
--               design_4_util_ds_buf_2_0_ system_util_ds_buf_2_0_sim_netlist.vhdl
...
entity design_4_util_ds_buf_2_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of design_4_util_ds_buf_2_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of design_4_util_ds_buf_2_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of design_4_util_ds_buf_2_0_util_ds_buf : entity is "OBUFDS";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of design_4_util_ds_buf_2_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of design_4_util_ds_buf_2_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of design_4_util_ds_buf_2_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of design_4_util_ds_buf_2_0_util_ds_buf : entity is 2;
end design_4_util_ds_buf_2_0_util_ds_buf;

architecture STRUCTURE of design_4_util_ds_buf_2_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_4_util_ds_buf_2_0 is
  port (
    OBUF_IN : in STD_LOGIC_VECTOR ( 1 downto 0 );
    OBUF_DS_P : out STD_LOGIC_VECTOR ( 1 downto 0 );
    OBUF_DS_N : out STD_LOGIC_VECTOR ( 1 downto 0 )
  ...
  attribute NotValidForBitStream of design_4_util_ds_buf_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_4_util_ds_buf_2_0 : entity is "system_util_ds_buf_2_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_4_util_ds_buf_2_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_4_util_ds_buf_2_0 : entity is "util_ds_buf,Vivado 2020.1";
end design_4_util_ds_buf_2_0;

architecture STRUCTURE of design_4_util_ds_buf_2_0 is
...
begin
U0: entity work.design_4_util_ds_buf_2_0_util_ds_buf
     port map (
