...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axis_data_fifo_0_m_axis_tdata [get_bd_pins axis_data_fifo_0/m_axis_tdata] [get_bd_pins signal_spliter_0/s_axis_data]
  connect_bd_net -net axis_data_fifo_0_m_axis_tvalid [get_bd_pins axis_data_fifo_0/m_axis_tvalid] [get_bd_pins signal_spliter_0/s_axis_valid]
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_red_pitaya_adc_0/adc_clk]
  ...
  connect_bd_net -net axis_red_pitaya_adc_0_m_axis_tvalid [get_bd_pins axis_data_fifo_0/s_axis_tvalid] [get_bd_pins axis_red_pitaya_adc_0/m_axis_tvalid]
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins cordic_0/aresetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins ff_0/rstn] [get_bd_pins ff_1/rstn] [get_bd_pins ff_2/rstn] [get_bd_pins fir_compiler_0/aresetn] [get_bd_pins fir_compiler_1/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
  connect_bd_net -net signal_spliter_0_m_axis_cosine_data [get_bd_pins mult_gen_0/B] [get_bd_pins signal_spliter_0/m_axis_cosine_data]
  connect_bd_net -net signal_spliter_0_m_axis_cosine_valid [get_bd_pins ff_0/data_in] [get_bd_pins signal_spliter_0/m_axis_cosine_valid]
  connect_bd_net -net signal_spliter_0_m_axis_sine_data [get_bd_pins mult_gen_0/A] [get_bd_pins mult_gen_1/A] [get_bd_pins mult_gen_1/B] [get_bd_pins signal_spliter_0/m_axis_sine_data]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins dds_compiler_0/s_axis_phase_tdata] [get_bd_pins xlconstant_1/dout]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins axis_data_fifo_0/m_axis_tready] [get_bd_pins xlconstant_4/dout]
  ...
  connect_bd_net -net xlslice_6_Dout [get_bd_pins Q3_14_to_Q2_14_0/in_data] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins Q3_14_to_Q2_14_1/in_data] [get_bd_pins xlslice_7/Dout]
